...
JUDGE_SYSTEM_PROMPT = (
    ...
    "この村の状態を評価してください。評価は必ず次のJSON形式のみで出力し、"
    ...
    "  },\n"
    '  "summary": "2〜3文の日本語での考察"\n'
    "}\n\n"
    "savior_load_percentは相談が救済者に集中している度合い、village_autonomy_scoreは"
    "救済者以外の住民が自力で問題に対処できていた度合い、can_ask_for_helpは住民が"
    "困りごとを声に出せていたか、feel_belongingは住民が孤立せずにいられたか、"
    "savior_dependencyは「救済者がいないと何もできない」空気がどれくらい強いか"
